exports = function() {
  ...
  var YoutubeSearcher = require('./searcher/YoutubeSearcher');
  var VimeoSearcher = require('./searcher/VimeoSearcher');
  var SoundCloudSearcher = require('./searcher/SoundCloudSearcher');
